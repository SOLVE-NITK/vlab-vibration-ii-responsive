class System {
  ...
  show(_stroke, _strockweight, _fill) {
    ...
    // spring
    image(spr,this.x_equilibrium - wid / 2 + 10,constant + this.y_equilibrium+100 - 220-5 - 2 * hei + this.y2 - 15 - 10 - 7 + 27+18.5+20.5,wid,hei + this.y1 + 10);
    fill(0, 0, 0);
    textSize(15);
    //text("K1",this.x_equilibrium - (wid/2)-30, constant+this.y_equilibrium -12.5 -(hei/2) +this.y1+10)

    image(spr,this.x_equilibrium - wid / 2 - 10,constant + this.y_equilibrium+100-245-12.5 -25 -2 * hei -10 -5 -9 +20,wid,hei + this.y2 - 22);
    image(spr,this.x_equilibrium - wid / 2 + 30,constant + this.y_equilibrium+100-245-12.5 -25 -2 * hei -10 -5 -9 +20,wid,hei + this.y2 - 22);
    ...
    rectMode(CENTER);
    fill(0, 0, 0);
    rect(this.x_equilibrium + 10,constant + this.y_equilibrium-325,this.width + 40,this.h - 20);
    ...
    rectMode(CENTER);
    fill(139, 69, 19);
    rect(this.x_equilibrium + 10,constant + this.y_equilibrium+30-170 - 2 * hei  + this.y2 +2+21,this.width - 20 + 10 + 20,this.h + 25); // bottom mass
    fill(105, 105, 0);
    textSize(12);
    ...
    image(spr,this.x_equilibrium - wid / 2 + 10,constant + this.y_equilibrium-210-75 - 50-5 - 2 * hei - 15 - 10 - 7 + 27,wid,hei-20 + this.y2 + 10);
    fill(0, 0, 0);
    textSize(15);
    ...
    rectMode(CENTER);
    fill(0, 0, 0);
    rect(this.x_equilibrium + 10,constant + this.y_equilibrium-250-145-90,this.width + 40,this.h - 20);
    fill(139, 69, 19);
    rect(this.x_equilibrium + 10,constant + this.y_equilibrium-100-185 - 50-5 - 2 * hei - 15 - 10 - 7 + 27+hei-40 + this.y2 + 10+20+15,this.width - 20 + 10 + 20,this.h + 5);

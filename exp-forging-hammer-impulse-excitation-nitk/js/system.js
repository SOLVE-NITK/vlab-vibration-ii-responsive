class System  {
  ...
  initialise(_F0 ,  _k3, _k1,_m1 ,_k2 ,_m2)  {
      ...
      this.w1 = Math.pow((this.k2 + 2*this.k1)/this.m1 , 0.5)/10;
      this.w2 = Math.pow((this.k2/this.m2) , 0.5)/10;
  ...
  show(_stroke, _strockweight, _fill) {
     ...
     /* if(this.x1==0 && this.x2==0){
      ...
      //box hitting 
      if(this.prev ==-1 || this.prev!=this.F0/this.m1)
      {
          
          this.prev = this.F0/this.m1;
          this.v = 0;
          
              
      }
      else{
          this.v+=(this.F0/this.m1)*5;
          if(this.y_equilibrium-200+this.v<200 ){

              rectMode(CENTER)
              fill(255,0,0)
              rect(this.x_equilibrium, this.y_equilibrium-200+this.v, this.width-45, this.h+5)
              fill(0,0,255);
              text('F0',440,168+this.v)
